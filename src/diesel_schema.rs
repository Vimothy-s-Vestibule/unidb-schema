...
diesel::table! {
    ...
    user_platform_association (platform_id) {
...
diesel::allow_tables_to_appear_in_same_query!(
    channels,messages,scores,skills,social_platforms,user_platform_association,user_skill_evidence,user_skills,vestibule_users,youtube_channels,youtube_comment_threads,youtube_comments,youtube_videos,);
